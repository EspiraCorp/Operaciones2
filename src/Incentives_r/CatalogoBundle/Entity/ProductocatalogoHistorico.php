...
/**
 * ProductocatalogoHistorico
 *
 * @ORM\Entity
 * @ORM\Table(name="ProductocatalogoHistorico")
 */
class ProductocatalogoHistorico
{
    /**
     * @var integer
     *
    ...
    /**
     * @var string
     * @ORM\ManyToOne(targetEntity="Incentives\CatalogoBundle\Entity\Productocatalogo", inversedBy="productocatalogoHistorico")
     ...
     * @return ProductocatalogoHistorico
     */
