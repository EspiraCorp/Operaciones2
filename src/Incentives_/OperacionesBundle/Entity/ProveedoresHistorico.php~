...
class ProveedoresHistorico
{
     ...
     * @var string
     *
     * @ORM\Column(name="tiempo_entrega", type="string", length=255, nullable=true)
     */
    ...
    /**
     * 
     * @ORM\ManyToOne(targetEntity="Proveedores", inversedBy="proveedorhistorico", cascade={"persist", "remove"})
     ...
     * Set proveedor
     *
     * @param \Incentives\OperacionesBundle\Entity\ProveedoresHistorico $proveedor
     * @return ProveedoresHistorico
     */
    public function setProveedor(\Incentives\OperacionesBundle\Entity\ProveedoresHistorico $proveedor = null)
    {
     ...
     * Get proveedor
     *
     * @return \Incentives\OperacionesBundle\Entity\ProveedoresHistorico 
     */
     ...
     * Set usuario
     *
     * @param \Incentives\OperacionesBundle\Entity\ProveedoresHistorico $usuario
     * @return ProveedoresHistorico
     */
    public function setUsuario(\Incentives\OperacionesBundle\Entity\ProveedoresHistorico $usuario = null)
    {
