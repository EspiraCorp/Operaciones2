 ...
 * Redencionesenvios
 *
 * @ORM\Table(name="Redencionesenvios")
 * @ORM\Entity
 */
class Redencionesenvios
{
    /**
     * @var integer
     *
    ...
    private $observaciones;
     ...
     /**
     * 
     * @ORM\ManyToOne(targetEntity="Incentives\RedencionesBundle\Entity\Redenciones", inversedBy="redencionesenvios", cascade={"persist", "remove"})
    ...
    /**
     * @ORM\OneToMany(targetEntity="GuiaEnvio", mappedBy="redencionenvio", cascade={"persist"})
     */
    protected $guia;
